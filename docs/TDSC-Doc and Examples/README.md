...
### 4. ~~Masthead Cutout Persists in Spilled Paragraphs~~ (FIXED)

**Status:** FIXED in January 2026

**Original Issue:** When a paragraph started on a page with a masthead and continued to the next page (paragraph spill), the text on the second page would flow in a narrow column as if the masthead were still present.

**Solution:** The paragraph spill mechanism now re-layouts spilled content when the current page has no cutouts. When a paragraph was originally laid out with masthead/wrap cutouts on page 1, and then spills to page 2 which has no cutouts, the spilled lines are automatically re-laid out at full width.

This fix ensures text flows correctly at full width on pages without mastheads or wraps, regardless of where the paragraph started.
